...
namespace API.SignalR
{
    public class MessageHub : Hub
    {
        ...
        {
            await RemoveFromChatGroup(Context.ConnectionId);
        ...
        public async Task SendMessage(CreateMessageDto createMessageDto)
        {
            ...
            if (username == createMessageDto.RecipientUserName.ToLower()) throw new HubException("Wrong recipient");
        ...
        private async Task RemoveFromChatGroup(string connectionId)
        {
